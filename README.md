...
With vs code: ctrl+shift+p > "Debug: Debug npm script" > "dev"

This starts your app in development mode, rebuilding assets on file changes.

The database seed (seed.ts) script creates a new user with some data you can use to get started:
...
// should fix the typescript import `type`
"editor.codeActionsOnSave": {
  "source.fixAll.eslint": true, // fix import with "type" warning
  "source.organizeImports": true, // optional
}
```

### Relevant code and librairies
