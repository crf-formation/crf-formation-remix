import type {
  PseUserPreparatoryWorkApiObject,
  PseUserPreparatoryWorkPostApiObject
} from "~/apiobject/pseuserpreparatorywork.apiobject";
import { pseUserPreparatoryWorkEntityToApiObject } from "~/mapper/pseformationpreparatorywork.mapper";
import {
  getPseUserPreparatoryWorkEntities,
  updatePseUserPreparatoryWorkEntities
} from "~/repository/pseformationpreparatorywork.repository";
