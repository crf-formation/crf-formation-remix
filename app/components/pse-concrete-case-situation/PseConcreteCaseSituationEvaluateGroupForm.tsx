...
function PseCompetenceRow({ pseCompetence, shouldBeEvaluated, pseConcreteCaseGroup }: { pseCompetence: PseCompetenceDto, shouldBeEvaluated: boolean, pseConcreteCaseGroup: PseConcreteCaseGroupDto }) {
