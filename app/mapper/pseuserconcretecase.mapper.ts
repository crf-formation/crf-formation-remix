import type {
  PseEvaluationCompetenceGradeApiObject,
  PseEvaluationCompetenceGradePostApiObject,
  PseUserConcreteCaseApiObject,
  PseUserConcreteCaseCompetenceApiObject,
  PseUserConcreteCaseCompetenceGradeApiEnum,
  PseUserConcreteCaseGroupEvaluationApiObject,
  PseUserConcreteCaseRoleApiEnum,
  PseUserConcreteCaseStateApiEnum,
  PseUserEvaluationApiObject,
  PseUserEvaluationPostApiObject
} from "~/apiobject/pseuserconcretecase.apiobject";
import type {
  PseEvaluationCompetenceGradeDto,
  PseEvaluationCompetenceGradePostDto,
  PseUserConcreteCaseCompetenceDto,
  PseUserConcreteCaseCompetenceGradeDtoEnum,
  PseUserConcreteCaseDto,
  PseUserConcreteCaseGroupEvaluationDto,
  PseUserConcreteCaseGroupEvaluationPostDto,
  PseUserConcreteCaseRoleDtoEnum,
  PseUserConcreteCaseStateDtoEnum,
...
import {
  ...
  pseConcreteCaseGroupEntityToApiObject
} from "./pseconcretecasegroup.mapper";
import {
  pseConcreteCaseSituationApiObjectToDto,
  pseConcreteCaseSituationEntityToApiObject
} from "./pseconcretecasesituation.mapper";
